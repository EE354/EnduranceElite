...
<main>
    ...
    <div class="container flex flex-wrap align-center justify-center">
        ...
        <div class="w-11/12 neutral  shadow-lg m-4 p-4 text-center">
            ...
            <h4>*No annual registration fee.</h4>
        </div>
        ...
        <div class="md:flex">
            ...
            <div class="neutral shadow-lg m-4 p-4 rounded-xl">
                ...
                <br><p>
                    *Create a Parent Portal before showing up to the gym. All waivers and credit card information must be input before hand to save on time
                    <br>*Sign in at front desk for Adult Class
                    <br>*Pay the Drop-In rate of $12 a class with the front desk staff
                    <br>*No discounts will be applied to Drop-In rates.
                    <br>*Attend any Adult class throughout the week and experience an array of fitness.
                    <br>*Your schedule, your choices.
                </p>

                <br><hr><br>

                <h4 class="text-center">Attending Open Gym:</h4>
                <p>
                    *Create a Parent Portal before showing up to the gym. All waivers and credit card information must be input before hand to save on time 
