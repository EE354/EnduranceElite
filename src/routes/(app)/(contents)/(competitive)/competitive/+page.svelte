    ...
    <div class="container flex flex-wrap justify-center pb-8">
        ...
        <div class="md:flex">
            ...
            <div class="w-11/12 neutral justify-center shadow-lg m-4 p-4">
                ...
                <br><p><b> *Please Note: Elite Dance Company participation is through invitation only.</b></p>
            </div>
        </div>
        ...
        <div class="flex-column md:grid md:grid-cols-3 text-center">
            ...
            <div class="bg-primary-400 dark:bg-primary-900 p-16 col-span-1">
                ...
                <div class="relative md:h-[14rem]">
                    <h4>TEAM INFORMATION</h4>
                    <p>Endurance Elite Competitive Team and how to join!</p>
            ...
            <div class="bg-secondary-400 dark:bg-secondary-800 p-16 col-span-1">
                <svg class="container" preserveAspectRatio="xMidYMid meet" data-bbox="53.245 47.211 93.512 105.578" viewBox="53.245 47.211 93.512 155" height="120" width="200" xmlns="http://www.w3.org/2000/svg" data-type="tint" role="presentation" aria-hidden="true">
                    <g>
                        ...
                        <path d="M141.5 135.789h-83v7h-5v10h93v-10h-5v-7zm-80 3h77v4h-77v-4zm82 7v4h-87v-4h87z" fill="#FFFFFF"></path>
                        <path d="M93.5 72.289c0 3.584 2.916 6.5 6.5 6.5s6.5-2.916 6.5-6.5-2.916-6.5-6.5-6.5-6.5 2.916-6.5 6.5zm10 0c0 1.93-1.57 3.5-3.5 3.5s-3.5-1.57-3.5-3.5 1.57-3.5 3.5-3.5 3.5 1.57 3.5 3.5z" fill="#FFFFFF"></path>
                    </g>
                </svg>
                <div class="relative md:h-[14rem]">
                    <h4>COLLEGE RECRUITERS</h4>
                    <p>Meet our college bound gymnasts and where to watch them</p>
            ...
            <div class="bg-primary-300 dark:bg-primary-700 p-16 col-span-1">
                ...
                <div class="relative md:h-[14rem]">
                    <h4>CALENDAR</h4>
                    <p>Mark your calendars! Get information on competitions, fundraisers and performances.</p>
                    <a href="/calendar" class="md:absolute inset-x-0 bottom-0">READ MORE ></a>
                </div>
            </div>
        </div>
