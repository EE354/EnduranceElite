    ...
    <div class="container flex flex-wrap justify-center">
        <div class="w-11/12 bg-neutral-100 justify-center shadow-lg m-4 p-4">
            ...
            <nav class="flex flex-wrap gap-2">
                <a href="#babynastics" class="btn bg-primary-600 dark:bg-primary-900" on:click|preventDefault={scrollIntoView}>Babynastics</a>
                <a href="#tumbling" class="btn bg-primary-600 dark:bg-primary-900" on:click|preventDefault={scrollIntoView}>Tumbling Tots</a>
                <a href="#prenastics" class="btn bg-primary-600 dark:bg-primary-900" on:click|preventDefault={scrollIntoView}>Prenastics</a>
            </nav>
        </div>
