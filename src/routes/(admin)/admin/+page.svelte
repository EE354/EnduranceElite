...
<main class="bg-[url('$lib/Regular/background.jpg')] bg-secondary-500 dark:bg-secondary-900 bg-contain p-6">
    ...
    <div class="container py-4 grid place-items-center lg:flex flex-wrap justify-center">
        <!-- Card Block -->
    ...
    <div class="container py-4">
        <!-- Card Block -->
        <div class="grid place-items-center lg:flex flex-wrap justify-center">
    ...
    <div class="card container w-full bg-primary-600 dark:bg-primary-900 lg:flex flex-row">
        ...
        <div class="flex flex-col p-4 lg:pt-8 lg:pr-8">
            <h2>Competitions</h2>
