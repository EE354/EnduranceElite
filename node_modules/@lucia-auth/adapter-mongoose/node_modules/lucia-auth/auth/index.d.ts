...
export declare class Auth<C extends Configuration = any> {
    ...
    handleRequest: (...args: Parameters<Lucia.Auth["middleware"]>) => AuthRequest<Lucia.Auth>;
    ...
    createKey: <KeyData extends {
        ...
        password: string | null;
        expiresIn: number;
    }>(userId: string, keyData: KeyData) => Promise<GetKeyFromType<KeyData["type"]>>;
...
type GetKeyFromType<Type extends string> = Type extends PersistentKey["type"] ? PersistentKey : Type extends SingleUseKey["type"] ? SingleUseKey : never;
export {};
